...
add("Başur Höyük", "archaeological mound footprint", 3.75, 3.75, qualifier="calculated approximate", area_basis="mound footprint", start=-7000, end=1300, citation="Baysal and Sağlamtimur, American Journal of Archaeology 125 (2021).", url="https://www.journals.uchicago.edu/doi/10.3764/aja.125.1.0003", confidence="medium", notes="Calculated from the published mound dimensions of 250 × 150 m; not every occupation phase used the full footprint.")
...
add("Kienuka", "fortified enclosure", 2.53, 2.53, qualifier="calculated approximate", area_basis="fortified enclosure footprint", start=1500, end=1687, citation="New York State Military Museum, 'Kienuka, Fortress.'", url="https://museum.dmna.ny.gov/forts/kienuka", source_tier="official government", source_type="state military museum site record", confidence="medium", notes="Calculated and rounded from the reported enclosure dimensions of about 20 × 50 rods.")
add("Crow Creek", "Initial Coalescent fortified village, c. 1325 CE", 7.3, 7.3, qualifier="reported", area_basis="fortified village footprint", start=1200, end=1350, citation="Willey and Emerson, Plains Anthropologist 38 (1993).", url="https://doi.org/10.1080/2052546.1993.11931655", confidence="high", notes="The published 7.3-ha figure is the Initial Coalescent component enclosed by the fortification ditch.")
