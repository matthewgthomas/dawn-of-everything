  ...
  return (
    <aside ref={panelRef} className="about-panel" role="dialog" aria-modal="true" aria-labelledby="about-title">
      ...
      <div className="about-content">
        ...
        <section><h3>Method and caveats</h3><p>The catalogue is curated at paragraph level across the substantive text and notes. Every included mention retains its complete source paragraph, even when that paragraph also names a place outside the curated set. Occupation dates summarise known periods of habitation rather than claiming continuous occupation, and may not be dates stated in the associated passage.</p><p>Settlement-area observations are a separate source-backed research synthesis. They retain period-specific estimates, uncertainty, measurement basis, and explicit unknown findings. Comparisons with landmarks, islands and festival grounds are orientation aids; each reference identifies the land area being compared and links to its source.</p><p>Coordinates are representative points, not settlement boundaries. Four records remain deliberately unlocated because the evidence does not support a unique physical point.</p></section>
